describe ManageIQ::Providers::Telefonica::CloudManager::OrchestrationTemplate do
  ...
  let(:yaml_template) { FactoryGirl.create(:orchestration_template_telefonica_in_yaml) }
  let(:json_template) { FactoryGirl.create(:orchestration_template_telefonica_in_json) }
