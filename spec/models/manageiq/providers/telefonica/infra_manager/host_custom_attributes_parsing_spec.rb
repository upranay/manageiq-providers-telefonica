  ...
  describe "#refresh_custom_attributes_from_conf_files" do
    let(:host) do
      FactoryGirl.create(:host_telefonica_infra).tap do |host|
        host.system_services << FactoryGirl.create(:system_service, :name => 'telefonica-nova')
      end
    end

    describe "parse telefonica conf nice format" do
      it "parses nice format" do
        files = [FactoryGirl.create(:filesystem_telefonica_conf, :contents => filesystem_telefonica_conf_nice)]
      ...
      it "ignores headers containing ====" do
        files = [FactoryGirl.create(:filesystem_telefonica_conf, :contents => filesystem_telefonica_conf_ignore_header)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks random spaces doesn't change the format" do
        files = [FactoryGirl.create(:filesystem_telefonica_conf, :contents => filesystem_telefonica_conf_random_spaces)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks that only default value is present" do
        files = [FactoryGirl.create(:filesystem_telefonica_conf,
