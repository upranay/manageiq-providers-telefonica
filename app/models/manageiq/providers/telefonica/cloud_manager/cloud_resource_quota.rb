class ManageIQ::Providers::Telefonica::CloudManager::CloudResourceQuota < ::CloudResourceQuota
  private
  ...
  def key_pairs_quota_used
    Authentication.where(:resource_id   => ems.id,
                         ...
                         :type          => ManageIQ::Providers::Telefonica::CloudManager::AuthKeyPair.name).count
  end
