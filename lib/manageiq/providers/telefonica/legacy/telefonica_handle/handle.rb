...
module TelefonicaHandle
  class Handle
    ...
    def self.raw_connect_try_ssl(username, password, domain_name, project_name, address, port, service = "Compute", options = nil, security_protocol = nil)
      opts = options.dup
    ...
    def connect(options = {})
      ...
      svc_cache[tenant] ||= begin
        ...
        raw_service = self.class.raw_connect_try_ssl(username, password, domain_name, project_name, address, port, service, opts,
                                                     security_protocol)
